...
const Credit = () => {
  return (
    <div>
        <div style={{background:'rgba(168, 178, 248, 0.16)'}} className="md:flex">
           <div className='md:flex-[50%] px-10 py-[80px]'>
                <div className='flex items-center gap-2 mb-[50px]'>
                <img src="images/creditIcon.svg" alt="" />
                <span className='text-[24px] text-[#A8B2F8] font-bold'>Credit</span>
            </div>
           ...
           <div className='flex-[50%] flex md:justify-end justify-center items-center md:relative py-3'>
            <div className='md:w-[468px] h-[279px] w-[70%] md:absolute bottom-0 right-20 '>
                    <img src="images/credit.png" alt="" className='object-cover md:w-full md:h-full'/>
            </div>
           </div>
        </div>
        ...
        <div className='md:flex justify-center mx-3 py-5 md:justify-around items-center'>
            ...
            <div className='w-[331px] h-[318px] mx-auto p-5 bg-[#DDF3E880] md:my-20 my-5 rounded-md'>
                ...
                <h4 className='text-[#0A1045] text-[23px] my-3'>Access your funds at anytime</h4>Save funds at 
